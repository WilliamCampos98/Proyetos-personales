...
public abstract class CalculadoraAbstracta {
	 ...
	 */
	public abstract void sumar(double x, double y, double total);

	public abstract void dividir(double x, double y, double total);

	public abstract void restar(double x, double y, double total);

	public abstract void multiplicar(double x, double y, double total);
